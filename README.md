...
<img src="https://us-central1-trackgit-analytics.cloudfunctions.net/token/ping/la4bpfzw3tpls64tzxdl" alt="trackgit-views" />
</a>
...
END_FUNCTION_BLOCK
```
### Example (without static code analysis, Backward Translation)
###### .\tests\plcopen_examples\TC005_FB.xml
###### Command
>`(venv) C:\Python\plcrex_project>python -m plcrex fbd2st ".\tests\plcopen_examples\TC005_FB.xml" -bw`
