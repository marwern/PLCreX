...
def test_wrong_file():
    result = runner.invoke(cli.app, ["impact-analysis", r".\tests\other_examples\TC001_wrong_file.txt", r".\exports\st2ia1"])
    assert result.exit_code == 1

#test_bwd_noformal_io_analysis
def test_bwd_noformal_io_analysis():
    result = runner.invoke(cli.app, ["impact-analysis", r".\tests\plcopen_examples\TC006_FBD.xml", r".\exports\st2ia2"])
    assert result.exit_code == 0
